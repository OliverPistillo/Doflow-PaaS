...
export const DOFLOW_TENANT_NAVIGATION: TenantNavigationSection[] = [
  ...
  },
  {
    ...
    moduleKey: "crm",
    children: [
      { id: "companies", label: "Aziende", href: "/companies", icon: Building2, moduleKey: "crm" },
      { id: "contacts", label: "Contatti", href: "/contacts", icon: Contact, moduleKey: "crm" },
      { id: "leads", label: "Lead", href: "/leads", icon: UserPlus, moduleKey: "crm" },
      { id: "deals", label: "Opportunità", href: "/deals", icon: Handshake, moduleKey: "crm" },
      { id: "pipeline", label: "Pipeline", href: "/pipeline", icon: Layers, moduleKey: "crm" },
      { id: "briefings", label: "Briefing", href: "/briefings", icon: FileText, moduleKey: "briefing" },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "documents", label: "Documenti", href: "/documents", icon: FolderOpen, moduleKey: "documents" },
    ],
  },
  {
    id: "amministrazione",
