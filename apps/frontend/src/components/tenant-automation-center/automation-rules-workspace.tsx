...
import { actionNames, formatDateTime, isToday, loadRules, loadRuns, ruleArea, ruleStatus, triggerLabel } from "./automation-center-model";
...
export function AutomationRulesWorkspace() {
  ...
  const load = async () => {
    if (!canView("automations")) { setLoading(false); return; } setLoading(true); setError(null);
