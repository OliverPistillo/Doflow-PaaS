...
const EXISTING_TENANT_ROUTES = new Set([
  ...
  "/knowledge/assets",
  "/knowledge/assets/collections",
  "/knowledge/assets/new",
...
const AGENCY_MENUS: Record<AgencyAudience, AgencyNavGroup[]> = {
  executive: [
    ...
    },
    {
      ...
      modules: [
        item("Panoramica", "/calendar", CalendarDays, { minPlan: "PRO" }),
        item("Eventi", "/calendar/events", CalendarDays, { minPlan: "PRO" }),
        item("Agenda", "/calendar/agenda", Clock, { minPlan: "PRO" }),
        item("Settimana", "/calendar/week", CalendarDays, { minPlan: "PRO" }),
        item("Timeline", "/calendar/timeline", Workflow, { minPlan: "PRO" }),
        item("Scadenze", "/calendar/deadlines", FileClock, { minPlan: "PRO" }),
        item("Workload", "/calendar/workload", BarChart3, { minPlan: "PRO" }),
        item("Conflitti", "/calendar/conflicts", ClipboardCheck, { minPlan: "PRO" }),
        item("Disponibilità", "/calendar/availability", CalendarDays, { minPlan: "PRO" }),
        item("Viste", "/calendar/views", BookTemplate, { minPlan: "PRO" }),
        item("Activity", "/calendar/activity", FileText, { minPlan: "PRO" }),
      ],
    },
    {
      label: "Clienti",
    ...
    },
    {
      label: "Knowledge",
      modules: [
        item("Panoramica", "/knowledge", BookTemplate, { minPlan: "PRO" }),
        item("Ricerca", "/knowledge/search", FileText, { minPlan: "PRO" }),
        item("Articoli", "/knowledge/articles", FileText, { minPlan: "PRO" }),
        item("Categorie", "/knowledge/categories", FolderOpen, { minPlan: "PRO" }),
        item("Tag", "/knowledge/tags", Layers, { minPlan: "PRO" }),
        item("Preferiti", "/knowledge/favorites", BadgeCheck, { minPlan: "PRO" }),
        item("Asset", "/knowledge/assets", FolderOpen, { minPlan: "PRO" }),
        item("Raccolte asset", "/knowledge/assets/collections", Layers, { minPlan: "PRO" }),
        item("Template operativi", "/knowledge/templates", BookTemplate, { minPlan: "PRO" }),
        item("Activity", "/knowledge/activity", ClipboardCheck, { minPlan: "PRO" }),
      ],
    },
    {
