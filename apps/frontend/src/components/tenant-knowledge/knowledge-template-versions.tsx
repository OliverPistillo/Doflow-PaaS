...
import type { OperationalTemplateVersion } from "@/lib/tenant-knowledge-api";
import { compactJson, formatDateTime } from "./knowledge-utils";
import { Empty } from "./knowledge-shared";

export function KnowledgeTemplateVersions({ versions }: { versions: OperationalTemplateVersion[] }) {
  return (
    <Card>
      <CardHeader><CardTitle>Versioni template</CardTitle></CardHeader>
