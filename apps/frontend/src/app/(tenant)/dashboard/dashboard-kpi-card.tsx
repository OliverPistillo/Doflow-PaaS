...
export function DashboardKpiCard({
  ...
  return (
    <section className="dashboard-card min-h-[132px] p-5">
      ...
      <p className="mt-4 text-[30px] font-bold leading-none tabular-nums text-foreground">{value}</p>
      <p className={cn("mt-3 flex items-center gap-1 text-xs", hasHint ? "text-emerald-600" : "text-muted-foreground")}>
