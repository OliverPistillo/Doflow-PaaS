...
const typeLabels = { activity: "Attività", deadline: "Scadenze", project: "Progetti", client: "Clienti", lead: "Lead", support: "Supporto", comment: "Commenti", system: "Sistema" } as const
...
export default function NotificationsPage() {
  ...
  const { notifications, summary: serverSummary, markRead, archive, markAllRead } = useDoflowNotifications()
  ...
  const unread = notifications.filter((item) => !item.read && !item.archived)
