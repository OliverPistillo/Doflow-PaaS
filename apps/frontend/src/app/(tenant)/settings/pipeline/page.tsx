  ...
  return (
    <div className="flex-1 p-4 md:p-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Configurazione Pipeline</h2>
          <p className="text-sm text-muted-foreground mt-0.5">Personalizza stadi e campi della pipeline</p>
        </div>
      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-20 text-center">
          <div className="h-16 w-16 rounded-2xl bg-indigo-100 dark:bg-indigo-900/20 flex items-center justify-center mb-4">
            <GitFork className="h-8 w-8 text-indigo-600 dark:text-indigo-400" />
          </div>
