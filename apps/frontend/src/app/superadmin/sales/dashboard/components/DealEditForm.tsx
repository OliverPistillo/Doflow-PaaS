  ...
  return (
    <div className="space-y-6 px-1">
      ...
      <div className="flex items-center justify-between border-b pb-4 mb-4">
        <div>
           <h2 className="text-xl font-bold text-foreground">{formData.title}</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Servizi (Mock UI) */}
        <div className="grid gap-2 border p-3 rounded-md bg-muted/5">
        ...
        <div className="pt-4 flex justify-end gap-2 border-t mt-4">
          ...
          <Button type="submit" disabled={saving} className="bg-primary/10 hover:bg-primary/10">
