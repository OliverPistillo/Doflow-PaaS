...
export function GlobalFilterBar({ filters, onFilterChange }: GlobalFilterBarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-4 bg-card p-4 rounded-lg border border-border shadow-sm mb-6">
      <span className="text-sm font-semibold text-muted-foreground">Filtra per:</span>
