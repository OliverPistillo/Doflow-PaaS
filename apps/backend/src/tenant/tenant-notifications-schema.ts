...
export const BASE_NOTIFICATION_RULES: NotificationRuleSeed[] = [
  ...
  { key: 'contract_due_soon', name: 'Contratti in scadenza operativa', description: 'Avvisa sui contratti con due date entro 7 giorni.', category: 'system', severity: 'medium', config: { days: 7 }, targetRoles: ['manager', 'owner', 'admin', 'superadmin'] },
  { key: 'contract_overdue', name: 'Contratti scaduti', description: 'Avvisa sui contratti oltre la due date e non completati.', category: 'system', severity: 'high', targetRoles: ['manager', 'owner', 'admin', 'superadmin'] },
  { key: 'contract_waiting_signature', name: 'Contratti in attesa firma', description: 'Avvisa sui contratti fermi in stato firma.', category: 'system', severity: 'medium', targetRoles: ['manager', 'owner', 'admin', 'superadmin'] },
  { key: 'contract_expiring_30_days', name: 'Contratti in rinnovo/scadenza', description: 'Avvisa sui contratti con renewal date entro 30 giorni.', category: 'system', severity: 'medium', config: { days: 30 }, targetRoles: ['owner', 'admin', 'superadmin'] },
  { key: 'paperwork_due_soon', name: 'Scartoffie in scadenza', description: 'Avvisa sui dossier amministrativi in scadenza entro 7 giorni.', category: 'system', severity: 'medium', config: { days: 7 }, targetRoles: ['manager', 'owner', 'admin', 'superadmin'] },
  { key: 'paperwork_overdue', name: 'Scartoffie scadute', description: 'Avvisa sui dossier amministrativi scaduti.', category: 'system', severity: 'high', targetRoles: ['manager', 'owner', 'admin', 'superadmin'] },
  { key: 'paperwork_missing_required_items', name: 'Scartoffie obbligatorie mancanti', description: 'Avvisa quando mancano item amministrativi obbligatori.', category: 'system', severity: 'medium', targetRoles: ['manager', 'owner', 'admin', 'superadmin'] },
